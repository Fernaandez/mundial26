...
export const MATCH_SCHEDULE: Record<string, MatchScheduleEntry> = {
  ...
  // 16ens — slots ordenats segons el quadre oficial FIFA (r32-1 = dalt del quadre)
  "r32-1": s("2026-06-29", "16:30", "Boston"), // M74 1E v 3r
  "r32-2": s("2026-06-30", "17:00", "New York"), // M77 1I v 3r
  "r32-3": s("2026-06-28", "15:00", "Los Angeles"), // M73 2A v 2B
  "r32-4": s("2026-06-29", "21:00", "Monterrey"), // M75 1F v 2C
  "r32-5": s("2026-07-02", "19:00", "Toronto"), // M83 2K v 2L
  "r32-6": s("2026-07-02", "15:00", "Los Angeles"), // M84 1H v 2J
  "r32-7": s("2026-07-01", "20:00", "San Francisco"), // M81 1D v 3r
  "r32-8": s("2026-07-01", "16:00", "Seattle"), // M82 1G v 3r
  "r32-9": s("2026-06-29", "13:00", "Houston"), // M76 1C v 2F
  "r32-10": s("2026-06-30", "13:00", "Dallas"), // M78 2E v 2I
  "r32-11": s("2026-06-30", "21:00", "Ciutat de Mèxic"), // M79 1A v 3r
  "r32-12": s("2026-07-01", "12:00", "Atlanta"), // M80 1L v 3r
  "r32-13": s("2026-07-03", "18:00", "Miami"), // M86 1J v 2H
  "r32-14": s("2026-07-03", "14:00", "Dallas"), // M88 2D v 2G
  "r32-15": s("2026-07-02", "23:00", "Vancouver"), // M85 1B v 3r
  "r32-16": s("2026-07-03", "21:30", "Kansas City"), // M87 1K v 3r
  // 8ens
